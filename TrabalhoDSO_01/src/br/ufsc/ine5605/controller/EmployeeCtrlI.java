...
/**
 * Classe responsÃ¡vel pela comunicaÃ§Ã£o entre as classes Employee e EmployeeScreen entre si e com outras classes;
...
public class EmployeeCtrl implements Screen2, ConversionDates, Screen {
	 ...
	 * @param mainCtrl - Recebe uma instÃ¢ncia do MainController, o que permite a comunicaÃ§Ã£o com as outras classes, atravÃ©s do MainController;
	 */
	...
	/**
	 * Cria uma nova instÃ¢ncia de Employee e a adicona ao ArrayList<Employee>;
	 ...
	 * @param phone - int contendo o nÃºmero de telefone do Employee;
	 * @param salary - double contendo o salÃ¡rio do Employee;
	 * @return Employee - Retorna a instÃ¢ncia do objeto criado;
	 */
	...
	/**
	 * Cria uma nova instÃ¢ncia de Contract;
	 * @param employment - Recebe uma instÃ¢ncia da classe Employment;
	 * @param employee - Recebe uma instÃ¢ncia da classe Employee;
	 * @throws Exception Ocorre quando hÃ¡ uma tentativa de duplicaÃ§Ã£o de contrato;
	 */
	 ...
	 * @param e - InstÃ¢ncia do objeto a ser removido;
	 */
	 ...
	 * @return Employee - Retorna o objeto encontrado. Retorna null se o index usado no parÃ¢metro de entrada
	 * for incorreto(tentar acessar um indÃ­ce inexistente);
	 */
	...
	/**
	 * Verifica se o nÃºmero de registro existe
	 * @param numRegistration - int contendo o nÃºmero de registro que deseja ser verificado;
	 * @return boolean - Retorna true se existe algum Employee com o mesmo nÃºmero de registro, false se nÃ£o existe;
	 */
	...
	/**
	 * @deprecated - MÃ©todo criado, mas nunca utilizado. NÃ£o possuÃ­ utilidade algum, deletar depois;
